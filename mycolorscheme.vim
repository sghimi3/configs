...
if &t_Co > 255
   ...
   hi SpecialComment  ctermfg=6                cterm=bold
   ...
   hi Todo            ctermfg=231 ctermbg=25    cterm=bold
   ...
   if exists("g:rehash256") && g:rehash256 == 1
       ...
       hi Exception       ctermfg=48                cterm=none
       hi Float           ctermfg=135
       ...
       hi PreCondit       ctermfg=48                cterm=none
       ...
       hi Conceal         ctermfg=255 ctermbg=233
   endif
end
